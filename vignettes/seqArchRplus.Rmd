...
identification of clusters of promoter sequence architectures(@seqArchR), this package, 
...
samplas to produce a list of such plots. 
...
HTML file that enables scrolling between the combined panel plots for one 
sample to another.
