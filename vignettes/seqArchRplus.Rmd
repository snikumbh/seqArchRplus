...
on promoters in drosophila (Schor et al. 2017 and modENCODE), zebrafish 
(Nepal et al. 2013), mice (Fantom), humans (ENCODE), and also in plants 
(barley and maize).
...
```{r add-seqs-seqArchR-result, echo=FALSE}
## the sequence in example_promoters45.fa.gz and the seqArchR result 
## are the same. Hence, we can reduce seqArchR_result.rds size by assigning 
## them here instead
