...
seqArchR_clusts_ord <- seqArchRplus::order_clusters_iqw(sname = "sample1", 
                                                        clusts = use_clusts,
                                                        info_df = info_df, 
...
##
seqArchRplus::seqs_acgt_image(sname = "sample1",
                                seqs = raw_seqs,
...
seqlogos_oneplot_pl <- seqArchRplus::per_cluster_seqlogos(
                            sname = "sample1",
                            seqs = raw_seqs,
                            clusts = use_clusts,
...
# seqlogos_list_pl <- seqArchRplus::per_cluster_seqlogos(
                        #     sname = "sample1",
                        #     seqs = raw_seqs,
                        #     clusts = use_clusts,
                        #     pos_lab = -45:45, bits_yax = "auto",
...
stranded_seqlogos_pl <- seqArchRplus::per_cluster_seqlogos(
                            sname = "sample1",
                            seqs = raw_seqs,
                            clusts = use_clusts,
                            pos_lab = -45:45, bits_yax = "auto",
...
seqArchRplus::plot_motif_heatmaps(sname = "sample1", seqs = use_seqs,
                                    flanks = c(200),
                                    clusts = use_clusts,
...
de novo identified sequence clusters/architectures using seqArchR or any other 
